...
- Local highlight images removed from repo (now in .gitignore)
...
2. Add an entry to =src/data/people.json=:
   ...
   #+end_src
3. The =match= array controls which filenames map to this person (matches the subject slug, i.e. the part before the first =_= in the filename). Also matches numbered variants (e.g. =["jeremy"]= matches =jeremy-3.jpg=, =jeremy-11.jpg=).
