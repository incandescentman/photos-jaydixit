...
* TODO For Jay
- [ ] IMPORTANT: Add images of Jason Bateman, Russell Crowe, Rami Malek, Jude Law, Matt Damon, and Don Cheadle to the portfolio site.
...
- The preferred workflow is `scripts/photo-cli.js`, which merges EXIF/IPTC/XMP with `tags.json` and writes the merged title/caption back into the source file before upload
