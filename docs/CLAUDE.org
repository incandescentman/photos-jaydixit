...
- 2026-07-13: Fixed the cold-load Packery layout race and recorded the implementation plus cold-cache verification in [[file:debug/packery-cold-load-layout-race.org][the Packery cold-load bug report]]; the change is committed locally but not deployed
...
- [[file:debug/packery-cold-load-layout-race.org][debug/packery-cold-load-layout-race.org]] - Open cold-load Packery race bug report and implementation plan
