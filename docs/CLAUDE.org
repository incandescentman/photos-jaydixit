...
1. Ensure photos of the person exist in any gallery folder (filename must start with subject slug, e.g. =ray-kurzweil_event_2024.jpg=)
...
4. Build/dev to generate the page at =/portraits/ray-kurzweil=
5. The person also appears in the Portraits directory at =/portraits/=
