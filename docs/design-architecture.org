...
*** Photo Wall (=src/pages/photo-wall.astro=)
...
- Kinetic Editorial landing experience
- Large typographic introduction and darkroom print composition
- PhotoSwipe sequence for the hero prints
- Editorial profile, portrait wall, and public portfolio navigation
