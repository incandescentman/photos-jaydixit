...
*** Portraits (=src/pages/portraits/=)
- Per-person pages at =/portraits/[person-slug]= (e.g., =/portraits/jeremy-strong=)
- Index page at =/portraits/= listing all people alphabetically with sample photos
- Legacy =/red-carpet/= index and person routes receive HTTP 308 redirects to =/portraits/= through =vercel.json=; Astro redirect pages provide a local and static-host fallback
...
- [X] Add per-person portrait pages (=/portraits/[slug]=)
